...
class FileService(TypedDict, total=False):
    """"""
...
class FileServiceOutputs(TypedDict, total=False):
    """Outputs for FileService"""
...
class FileServiceBicep(Module):
    outputs: FileServiceOutputs
