...
class DataFactory(TypedDict, total=False):
    ...
    roleAssignments: List[Union['RoleAssignment', Literal['Contributor', 'Data Factory Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator']]]
    """Array of role assignments to create."""
    tags: Dict[str, object]
...
def data_factory(
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = DataFactoryBicep(symbol)
    output.outputs = {
