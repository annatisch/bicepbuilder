...
class NetworkProfile(TypedDict, total=False):
    ...
    accountAccess: 'AccountAcce'
    """Network access profile for batchAccount endpoint (Batch account data plane API)."""
    nodeManagementAccess: 'NodeManagementAcce'
    """Network access profile for nodeManagement endpoint (Batch service managing compute nodes for Batch pools)."""
...
class BatchAccount(TypedDict, total=False):
    """"""
    name: Required[str]
    """Name of the Azure Batch."""
    storageAccountId: Required[str]
    """The resource ID of the storage account to be used for auto-storage account."""
    keyVaultReferenceResourceId: str
    ...
    allowedAuthenticationModes: Literal['AAD', 'SharedKey', 'TaskAuthenticationToken']
    ...
    """Network access profile. It is only applicable when publicNetworkAccess is not explicitly disabled."""
    poolAllocationMode: Literal['BatchService', 'UserSubscription']
...
def batch_account(
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = BatchAccountBicep(symbol)
    output.outputs = {
