...
class EventGridTopic(TypedDict, total=False):
    """"""
    name: Required[str]
...
class EventGridTopicOutputs(TypedDict, total=False):
    """Outputs for EventGridTopic"""
    location: Output[Literal['string']]
    """The location the resource was deployed into."""
    name: Output[Literal['string']]
    """The name of the event grid topic."""
    privateEndpoints: Output[Literal['array']]
    """The private endpoints of the event grid topic."""
...
class EventGridTopicBicep(Module):
    outputs: EventGridTopicOutputs


def event_grid_topic(
        bicep: IO[str],
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = EventGridTopicBicep(symbol)
    output.outputs = {
