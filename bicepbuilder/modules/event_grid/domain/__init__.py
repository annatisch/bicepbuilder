...
class EventGridDomain(TypedDict, total=False):
    """"""
    name: Required[str]
...
class EventGridDomainOutputs(TypedDict, total=False):
    """Outputs for EventGridDomain"""
    location: Output[Literal['string']]
    """The location the resource was deployed into."""
    name: Output[Literal['string']]
    """The name of the event grid domain."""
    privateEndpoints: Output[Literal['array']]
    """The private endpoints of the event grid domain."""
    resourceGroupName: Output[Literal['string']]
    """The name of the resource group the event grid domain was deployed into."""
    resourceId: Output[Literal['string']]
    """The resource ID of the event grid domain."""
    systemAssignedMIPrincipalId: Output[Literal['string']]
    """The principal ID of the system assigned identity."""


class EventGridDomainBicep(Module):
    outputs: EventGridDomainOutputs


def event_grid_domain(
        bicep: IO[str],
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = EventGridDomainBicep(symbol)
    output.outputs = {
