...
class CdnProfile(TypedDict, total=False):
    ...
    roleAssignments: List[Union['RoleAssignment', Literal['CDN Endpoint Contributor', 'CDN Endpoint Reader', 'CDN Profile Contributor', 'CDN Profile Reader', 'Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator']]]
    """Array of role assignments to create."""
