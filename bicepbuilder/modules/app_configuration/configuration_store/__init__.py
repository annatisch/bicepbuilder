...
class ConfigurationStoreOutputs(TypedDict, total=False):
    """Outputs for ConfigurationStore"""
...
class ConfigurationStoreBicep(Module):
    outputs: ConfigurationStoreOutputs
...
def configuration_store(
        ...
        /,
        *,
        params: ConfigurationStore,
        scope: Optional[BicepExpression] = None,
        depends_on: Optional[Union[str, BicepExpression]] = None,
        name: Optional[Union[str, BicepExpression]] = None,
        tag: str = '0.5.0',
        registry_prefix: str = 'br/public:avm/res',
        path: str = 'app-configuration/configuration-store',
        batch_size: Optional[int] = None,
        description: Optional[str] = None,
) -> ConfigurationStoreBicep:
    symbol = "configuration_store_" + generate_suffix()
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = ConfigurationStoreBicep(symbol)
    output.outputs = {
