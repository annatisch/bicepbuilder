...
class AccessConnector(TypedDict, total=False):
    """"""
    name: Required[str]
...
class AccessConnectorOutputs(TypedDict, total=False):
    """Outputs for AccessConnector"""
...
class AccessConnectorBicep(Module):
    outputs: AccessConnectorOutputs
...
def access_connector(
        ...
        /,
        *,
        params: AccessConnector,
        scope: Optional[BicepExpression] = None,
        depends_on: Optional[Union[str, BicepExpression]] = None,
        name: Optional[Union[str, BicepExpression]] = None,
        tag: str = '0.3.0',
        registry_prefix: str = 'br/public:avm/res',
        path: str = 'databricks/access-connector',
        batch_size: Optional[int] = None,
        description: Optional[str] = None,
) -> AccessConnectorBicep:
    symbol = "access_connector_" + generate_suffix()
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = AccessConnectorBicep(symbol)
    output.outputs = {
