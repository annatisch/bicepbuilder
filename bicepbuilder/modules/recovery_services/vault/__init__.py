...
class RecoveryServicesVault(TypedDict, total=False):
    ...
    roleAssignments: List[Union['RoleAssignment', Literal['Backup Contributor', 'Backup Operator', 'Backup Reader', 'Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'Site Recovery Contributor', 'Site Recovery Operator', 'Site Recovery Reader', 'User Access Administrator']]]
    """Array of role assignments to create."""
