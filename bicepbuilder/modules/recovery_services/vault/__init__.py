...
if TYPE_CHECKING:
    ...
    from .replication_alert_setting import ReplicationAlertSetting
    from .replication_fabric import ReplicationFabric
...
class RoleAssignment(TypedDict, total=False):
    ...
    principalId: Required[str]
    """The principal ID of the principal (user/group/identity) to assign the role to."""
    roleDefinitionIdOrName: Required[Union[str, Literal['Backup Contributor', 'Backup Operator', 'Backup Reader', 'Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'Site Recovery Contributor', 'Site Recovery Operator', 'Site Recovery Reader', 'User Access Administrator']]]
    """The role to assign. You can provide either the display name of the role definition, the role definition GUID, or its fully qualified ID in the following format: '/providers/Microsoft.Authorization/roleDefinitions/c2f4ef07-c644-48eb-af81-4b1b4947fb11'."""
    condition: str
    """The conditions on the role assignment. This limits the resources it can be assigned to. e.g.: @Resource[Microsoft.Storage/storageAccounts/blobServices/containers:ContainerName] StringEqualsIgnoreCase "foo_storage_container"."""
    conditionVersion: Literal['2.0']
...
class RecoveryServicesVault(TypedDict, total=False):
    """"""
    name: Required[str]
    ...
    """The managed identity definition for this resource."""
    monitoringSettings: Dict[str, object]
    """Monitoring Settings of the vault."""
    privateEndpoints: List['PrivateEndpoint']
    """Configuration details for private endpoints. For security reasons, it is recommended to use private endpoints whenever possible."""
    protectionContainers: List[object]
    ...
    replicationAlertSettings: 'ReplicationAlertSetting'
    """Replication alert settings."""
    replicationFabrics: List['ReplicationFabric']
    """List of all replication fabrics."""
    replicationPolicies: List['ReplicationPolicy']
...
class RecoveryServicesVaultOutputs(TypedDict, total=False):
    """Outputs for RecoveryServicesVault"""
    location: Output[Literal['string']]
    """The location the resource was deployed into."""
    name: Output[Literal['string']]
    """The Name of the recovery services vault."""
    privateEndpoints: Output[Literal['array']]
    """The private endpoints of the recovery services vault."""
    resourceGroupName: Output[Literal['string']]
    """The name of the resource group the recovery services vault was created in."""
    resourceId: Output[Literal['string']]
    """The resource ID of the recovery services vault."""
    systemAssignedMIPrincipalId: Output[Literal['string']]
    """The principal ID of the system assigned identity."""


class RecoveryServicesVaultBicep(Module):
    outputs: RecoveryServicesVaultOutputs
...
def recovery_services_vault(
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = RecoveryServicesVaultBicep(symbol)
    output.outputs = {
