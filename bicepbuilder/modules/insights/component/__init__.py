...
class ComponentOutputs(TypedDict, total=False):
...
def component(
        ...
        *,
        ...
        path: str = 'insights/component',
        batch_size: Optional[int] = None,
        description: Optional[str] = None,
) -> ComponentBicep:
    symbol = "component_" + generate_suffix()
