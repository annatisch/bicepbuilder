...
class InsightsPrivateLinkScope(TypedDict, total=False):
    ...
    """Configuration details for private endpoints. For security reasons, it is recommended to use private endpoints whenever possible."""
    roleAssignments: List[Union['RoleAssignment', Literal['Contributor', 'Log Analytics Contributor', 'Log Analytics Reader', 'Logic App Contributor', 'Monitoring Contributor', 'Monitoring Metrics Publisher', 'Monitoring Reader', 'Network Contributor', 'Owner', 'Private DNS Zone Contributor', 'Reader', 'Role Based Access Control Administrator', 'Tag Contributor', 'User Access Administrator']]]
    """Array of role assignments to create."""
