...
class NetworkVirtualWan(TypedDict, total=False):
    """"""
    name: Required[str]
...
class NetworkVirtualWanOutputs(TypedDict, total=False):
    """Outputs for NetworkVirtualWan"""
    location: Output[Literal['string']]
    """The location the resource was deployed into."""
    name: Output[Literal['string']]
    """The name of the virtual WAN."""
    resourceGroupName: Output[Literal['string']]
    """The resource group the virtual WAN was deployed into."""
    resourceId: Output[Literal['string']]
    """The resource ID of the virtual WAN."""


class NetworkVirtualWanBicep(Module):
    outputs: NetworkVirtualWanOutputs


def network_virtual_wan(
        bicep: IO[str],
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = NetworkVirtualWanBicep(symbol)
    output.outputs = {
