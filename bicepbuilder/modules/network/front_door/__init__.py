...
class NetworkFrontDoor(TypedDict, total=False):
    """"""
    backendPools: Required[List[object]]
    """Backend address pool of the frontdoor resource."""
    frontendEndpoints: Required[List[object]]
    """Frontend endpoints of the frontdoor resource."""
    healthProbeSettings: Required[List[object]]
    """Heath probe settings of the frontdoor resource."""
    loadBalancingSettings: Required[List[object]]
    """Load balancing settings of the frontdoor resource."""
    name: Required[str]
    """The name of the frontDoor."""
    routingRules: Required[List[object]]
    ...
    enforceCertificateNameCheck: str
...
class NetworkFrontDoorOutputs(TypedDict, total=False):
    """Outputs for NetworkFrontDoor"""
    name: Output[Literal['string']]
    """The name of the front door."""
    resourceGroupName: Output[Literal['string']]
    """The resource group the front door was deployed into."""
    resourceId: Output[Literal['string']]
    """The resource ID of the front door."""


class NetworkFrontDoorBicep(Module):
    outputs: NetworkFrontDoorOutputs


def network_front_door(
        bicep: IO[str],
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = NetworkFrontDoorBicep(symbol)
    output.outputs = {
