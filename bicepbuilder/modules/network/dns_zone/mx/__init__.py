...
class MxOutputs(TypedDict, total=False):
    """Outputs for Mx"""
    name: Output[Literal['string']]
    """The name of the deployed MX record."""
    resourceGroupName: Output[Literal['string']]
    """The resource group of the deployed MX record."""
    resourceId: Output[Literal['string']]
    """The resource ID of the deployed MX record."""


class MxBicep(Module):
    outputs: MxOutputs
