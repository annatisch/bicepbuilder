...
class TrafficController(TypedDict, total=False):
    """"""
    name: Required[str]
...
class TrafficControllerOutputs(TypedDict, total=False):
    """Outputs for TrafficController"""
...
class TrafficControllerBicep(Module):
    outputs: TrafficControllerOutputs
...
def traffic_controller(
        ...
        /,
        *,
        params: TrafficController,
        scope: Optional[BicepExpression] = None,
        depends_on: Optional[Union[str, BicepExpression]] = None,
        name: Optional[Union[str, BicepExpression]] = None,
        tag: str = '0.1.0',
        registry_prefix: str = 'br/public:avm/res',
        path: str = 'service-networking/traffic-controller',
        batch_size: Optional[int] = None,
        description: Optional[str] = None,
) -> TrafficControllerBicep:
    symbol = "traffic_controller_" + generate_suffix()
    ...
    if depends_on:
        ...
        bicep.write(f"  ]\n")
    bicep.write(f"}}\n")
    output = TrafficControllerBicep(symbol)
    output.outputs = {
