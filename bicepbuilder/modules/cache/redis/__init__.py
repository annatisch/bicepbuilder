...
class Redi(TypedDict, total=False):
    """"""
    name: Required[str]
...
class RediOutputs(TypedDict, total=False):
    """Outputs for Redi"""
...
def redis(
        ...
        *,
        ...
        path: str = 'cache/redis',
        batch_size: Optional[int] = None,
        description: Optional[str] = None,
) -> RediBicep:
    symbol = "redis_" + generate_suffix()
