...
class RoleAssignment(TypedDict, total=False):
    ...
    roleDefinitionIdOrName: Required[Union[str, Literal['Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator', 'Virtual Machine Administrator Login', 'Virtual Machine Contributor', 'Virtual Machine Data Access Administrator (preview)', 'Virtual Machine User Login']]]
...
class ComputeAvailabilitySetModule(Module):
