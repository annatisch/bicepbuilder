...
class RoleAssignment(TypedDict, total=False):
    ...
    roleDefinitionIdOrName: Required[Union[str, Literal['Contributor', 'DICOM Data Owner', 'DICOM Data Reader', 'FHIR Data Contributor', 'FHIR Data Converter', 'FHIR Data Exporter', 'FHIR Data Importer', 'FHIR Data Reader', 'FHIR Data Writer', 'FHIR SMART User', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator']]]
...
class FhirserviceModule(Module):
