...
class Soa(TypedDict, total=False):
    ...
    """Array of role assignments to create."""
    soaRecord: Dict[str, object]
    """A SOA record."""
    ttl: int
    """The TTL (time-to-live) of the records in the record set."""


class SoaOutputs(TypedDict, total=False):
    """Outputs for Soa"""
    name: Output[Literal['string']]
    """The name of the deployed SOA record."""
    resourceGroupName: Output[Literal['string']]
    """The resource group of the deployed SOA record."""
    resourceId: Output[Literal['string']]
    """The resource ID of the deployed SOA record."""


class SoaModule(Module):
    outputs: SoaOutputs
