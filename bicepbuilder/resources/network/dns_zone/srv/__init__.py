...
class Srv(TypedDict, total=False):
    ...
    """Array of role assignments to create."""
    srvRecords: List[object]
    """The list of SRV records in the record set."""
    ttl: int
    """The TTL (time-to-live) of the records in the record set."""


class SrvOutputs(TypedDict, total=False):
    """Outputs for Srv"""
    name: Output[Literal['string']]
    """The name of the deployed SRV record."""
    resourceGroupName: Output[Literal['string']]
    """The resource group of the deployed SRV record."""
    resourceId: Output[Literal['string']]
    """The resource ID of the deployed SRV record."""


class SrvModule(Module):
    outputs: SrvOutputs
