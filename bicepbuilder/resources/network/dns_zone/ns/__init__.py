...
class NOutputs(TypedDict, total=False):
    """Outputs for N"""
    name: Output[Literal['string']]
    """The name of the deployed NS record."""
    resourceGroupName: Output[Literal['string']]
    """The resource group of the deployed NS record."""
    resourceId: Output[Literal['string']]
    """The resource ID of the deployed NS record."""
