...
class Txt(TypedDict, total=False):
    ...
    txtRecords: List[object]
    """The list of TXT records in the record set."""


class TxtOutputs(TypedDict, total=False):
    """Outputs for Txt"""
    name: Output[Literal['string']]
    """The name of the deployed TXT record."""
    resourceGroupName: Output[Literal['string']]
    """The resource group of the deployed TXT record."""
    resourceId: Output[Literal['string']]
    """The resource ID of the deployed TXT record."""


class TxtModule(Module):
    outputs: TxtOutputs
