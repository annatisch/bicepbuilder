...
class RoleAssignment(TypedDict, total=False):
    ...
    roleDefinitionIdOrName: Required[Union[str, Literal['Contributor', 'Logic App Contributor', 'Logic App Operator', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'User Access Administrator']]]
...
class LogicWorkflowModule(Module):
