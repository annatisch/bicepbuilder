...
if TYPE_CHECKING:
    ...
    from .linked_backend import LinkedBackend
...
class WebStaticSite(TypedDict, total=False):
    ...
    enableTelemetry: bool
    """Enable/Disable usage telemetry for module."""
    enterpriseGradeCdnStatus: Literal['Disabled', 'Disabling', 'Enabled', 'Enabling']
    """State indicating the status of the enterprise grade CDN serving traffic to the static web app."""
    functionAppSettings: Dict[str, object]
    ...
    templateProperties: Dict[str, object]
...
class WebStaticSiteOutputs(TypedDict, total=False):
    ...
    """The private endpoints of the static site."""
    resourceGroupName: Output[Literal['string']]
    """The resource group the static site was deployed into."""
    resourceId: Output[Literal['string']]
    """The resource ID of the static site."""
    systemAssignedMIPrincipalId: Output[Literal['string']]
    """The principal ID of the system assigned identity."""


class WebStaticSiteModule(Module):
